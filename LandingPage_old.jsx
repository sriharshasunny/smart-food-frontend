...
const LandingPage = () => {
    ...
    useEffect(() => {
        ...
        const FOOD_EMOJIS = ['≡ƒìö', '≡ƒìò', '≡ƒì⌐', '≡ƒî«', '≡ƒì▒', '≡ƒì£', '≡ƒìñ', '≡ƒÑ⌐', '≡ƒÑæ', '≡ƒÑ₧', '≡ƒÑ¿', '≡ƒìù', '≡ƒî¡', '≡ƒÑ¬'];
        const CORE_ITEMS = ['≡ƒìò', '≡ƒìö', '≡ƒì⌐', '≡ƒÑù', '≡ƒî«', '≡ƒì▒', '≡ƒì£', '≡ƒìñ'];
        const UFO_MESSAGES = ["Hungry? ≡ƒÿï", "Warp Speed! ≡ƒÜÇ", "Pizza Time? ≡ƒìò", "Incoming Delivery! ≡ƒôª", "Zoom! Γ£¿"];
