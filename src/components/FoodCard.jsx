...
const FoodCard = React.memo(({ food, restaurantName, variant = 'vertical', isFeatured = false, onAdd }) => {
    ...
    if (variant === 'horizontal') {
        return (
            ...
            <div
                className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 ease-out overflow-hidden group border border-gray-100 hover:border-orange-100 flex gap-4 p-4 hover:-translate-y-0.5 relative gpu-accelerated"
            >
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 ease-out overflow-hidden group border border-gray-100 hover:border-orange-100 flex flex-col h-full hover:-translate-y-1 relative gpu-accelerated">
