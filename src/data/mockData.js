...
import restModernDiner from '../assets/generated/rest_modern_diner_1767519597763.png';
import restSushiBar from '../assets/generated/rest_sushi_bar_1767519652742.png';
import restCozyCafe from '../assets/generated/rest_cozy_cafe_retry_1767519775895.png';
import restPizzeria from '../assets/generated/rest_pizzeria_1767519676316.png';
...
export const offers = [
    { id: 1, title: "50% OFF", description: "On your first order", image: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=800&q=80", code: "WELCOME50" },
    { id: 2, title: "Free Delivery", description: "On orders above $30", image: "https://images.unsplash.com/photo-1556910103-1c02745a30bf?auto=format&fit=crop&w=800&q=80", code: "FREEDEL" },
    { id: 3, title: "20% Cashback", description: "Pay via UPI", image: "https://images.unsplash.com/photo-1559339352-11d035aa65de?auto=format&fit=crop&w=800&q=80", code: "UPI20" }
];
...
export const mockRestaurants = [
    {
        ...
        costForTwo: "₹600",
        minOrder: 150,
        image: restCozyCafe, // Restaurant Interior (Warm)
    ...
    },
    {
        ...
        costForTwo: "₹400",
        minOrder: 100,
        image: restModernDiner, // Modern Diner
    ...
    },
    {
        ...
        costForTwo: "₹900",
        minOrder: 250,
        image: restPizzeria, // Italian Ambiance
    ...
    },
    {
        ...
        costForTwo: "₹700",
        minOrder: 200,
        image: restModernDiner, // Asian Restaurant
    ...
    },
    {
        ...
        costForTwo: "₹300",
        minOrder: 100,
        image: restCozyCafe, // Bright Cafe
...
export const mockDishes = [
    ...
    { id: 101, name: "Hyderabadi Chicken Biryani", price: 320, description: "Aromatic basmati rice cooked with tender chicken and spices.", image: "https://images.unsplash.com/photo-1589302168068-964664d93dc0?auto=format&fit=crop&w=800&q=80", restaurantId: 1, category: "Biryani", rating: 4.8, isVeg: false },
    { id: 102, name: "Butter Chicken", price: 290, description: "Creamy tomato curry with tender chicken pieces.", image: "https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?auto=format&fit=crop&w=800&q=80", restaurantId: 1, category: "Curry", rating: 4.7, isVeg: false },
    { id: 103, name: "Paneer Tikka Masala", price: 260, description: "Grilled paneer cubes in spicy gravy.", image: "https://images.unsplash.com/photo-1565557623262-b51c2513a641?auto=format&fit=crop&w=800&q=80", restaurantId: 1, category: "Curry", rating: 4.6, isVeg: true },
    { id: 104, name: "Garlic Naan", price: 60, description: "Freshly baked indian bread with garlic butter.", image: "https://images.unsplash.com/photo-1626074353765-517a681e40be?auto=format&fit=crop&w=800&q=80", restaurantId: 1, category: "Breads", rating: 4.5, isVeg: true },
    ...
    { id: 204, name: "Dragon Roll", price: 620, description: "Eel and cucumber topped with avocado.", image: "https://images.unsplash.com/photo-1617196035154-1e7e6e28b0db?auto=format&fit=crop&w=800&q=80", restaurantId: 2, category: "Sushi", rating: 4.9, isVeg: false },
    ...
    { id: 206, name: "Tempura Shrimp", price: 420, description: "Crispy fried shrimp batter.", image: "https://images.unsplash.com/photo-1615557960916-5f4791effe9d?auto=format&fit=crop&w=800&q=80", restaurantId: 2, category: "Starters", rating: 4.7, isVeg: false },
    { id: 207, name: "Spicy Tuna Roll", price: 480, description: "Tuna with spicy mayo.", image: "https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?auto=format&fit=crop&w=800&q=80", restaurantId: 2, category: "Sushi", rating: 4.6, isVeg: false },

    // 3. Burger King
    { id: 301, name: "Whopper", price: 220, description: "The classic flame-grilled beef burger.", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=800&q=80", restaurantId: 3, category: "Burger", rating: 4.5, isVeg: false },
    { id: 302, name: "Cheeseburger", price: 150, description: "Simple beef patty with cheddar cheese.", image: "https://images.unsplash.com/photo-1550547660-d9450f859349?auto=format&fit=crop&w=800&q=80", restaurantId: 3, category: "Burger", rating: 4.2, isVeg: false },
    { id: 303, name: "Chicken Royale", price: 190, description: "Crispy chicken breast with lettuce.", image: "https://images.unsplash.com/photo-1615297928064-24977384d0f9?auto=format&fit=crop&w=800&q=80", restaurantId: 3, category: "Burger", rating: 4.4, isVeg: false },
    ...
    { id: 306, name: "Onion Rings", price: 110, description: "Battered and fried onion rings.", image: "https://images.unsplash.com/photo-1639024471283-03518883512d?auto=format&fit=crop&w=800&q=80", restaurantId: 3, category: "Sides", rating: 4.4, isVeg: true },

    // 4. Italian Delight
    { id: 401, name: "Margherita Pizza", price: 350, description: "Classic tomato and mozzarella pizza.", image: "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?auto=format&fit=crop&w=800&q=80", restaurantId: 4, category: "Pizza", rating: 4.6, isVeg: true },
    ...
    { id: 502, name: "Veggie Spring Rolls", price: 180, description: "Crispy rolls filled with vegetables.", image: "https://images.unsplash.com/photo-1544681280-d2dc0444bedd?auto=format&fit=crop&w=800&q=80", restaurantId: 5, category: "Starters", rating: 4.4, isVeg: true },
    ...
    { id: 505, name: "Hakka Noodles", price: 240, description: "Stir-fried noodles with crisp veggies.", image: "https://images.unsplash.com/photo-1552611052-33e04de081de?auto=format&fit=crop&w=800&q=80", restaurantId: 5, category: "Main", rating: 4.5, isVeg: true },
    { id: 506, name: "Manchow Soup", price: 160, description: "Spicy and tangy soup with crispy noodles.", image: "https://images.unsplash.com/photo-1511690078903-71dc5a49f5e3?auto=format&fit=crop&w=800&q=80", restaurantId: 5, category: "Soup", rating: 4.3, isVeg: true },
    ...
    { id: 702, name: "Chicken Supreme", price: 480, description: "Loaded with chicken and veggies.", image: "https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=800&q=80", restaurantId: 7, category: "Pizza", rating: 4.7, isVeg: false },
    { id: 703, name: "Meat Lovers", price: 550, description: "Pepperoni, ham, beef, and sausage.", image: "https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?auto=format&fit=crop&w=800&q=80", restaurantId: 7, category: "Pizza", rating: 4.8, isVeg: false },
